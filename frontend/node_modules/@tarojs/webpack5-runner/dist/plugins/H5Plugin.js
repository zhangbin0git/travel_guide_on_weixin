...
class TaroH5Plugin {
    constructor(options = {}) {
        this.options = (0, lodash_1.defaults)(options || {}, {
            ...
            routerConfig: {},
            entryFileName: 'app',
            framework: helper_1.FRAMEWORK_MAP.REACT,
    ...
    apply(compiler) {
        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, compilation => {
            compiler.webpack.NormalModule.getCompilationHooks(compilation).loader.tap(PLUGIN_NAME, (_loaderContext, module) => {
                ...
                const { dir, name } = node_path_1.default.parse(module.resource);
                ...
                if (isBuildNativeComp
                    ...
                    : (isApp || this.appHelper.pagesConfigList.has(pageName.split(node_path_1.default.sep).join('/')))) {
