    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isMultiRouterMode) {
            const app = new app_1.default(config.entry, {
                sourceDir: node_path_1.default.join(appPath, config.sourceRoot || helper_1.SOURCE_DIR),
        ...
        const devServerOptions = (0, helper_1.recursiveMerge)({
            ...
            historyApiFallback: {
                ...
                rewrites: [{
                        ...
                        to: function (context) {
                            const pathname = chunkFilename.replace('[name]', node_path_1.default.basename(context.parsedUrl.pathname).replace(/\.[^.]*.hot-update\.(js|json)/, ''));
