...
class MiniCombination extends Combination_1.Combination {
    ...
    process(config) {
        ...
        if (isBuildPlugin) {
            ...
            chain.merge({
                context: node_path_1.default.join(process.cwd(), this.sourceRoot, 'plugin')
            });
        }
    ...
    getAlias() {
        ...
        return Object.assign(Object.assign({}, alias), { [`${helper_1.taroJsComponents}$`]: taroComponentsPath });
    }
    getOptimization() {
        return {
            usedExports: true,
