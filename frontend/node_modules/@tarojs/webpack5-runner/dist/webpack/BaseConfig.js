...
class BaseConfig {
        ...
        if ((_c = config.cache) === null || _c === void 0 ? void 0 : _c.enable) {
            ...
            const cacheDefault = {
                ...
                buildDependencies: {
                    ...
                    config: [(0, helper_1.resolveScriptPath)(node_path_1.default.join(appPath, 'config', 'index'))],
                    files: [(0, helper_1.resolveScriptPath)(node_path_1.default.join(appPath, 'src', 'app.config'))]
                },
    ...
    setMinimizer(config, defaultTerserOptions) {
        ...
        if (cssMinimizer === 'esbuild') {
            ...
            minimizer.lightningcssPlugin = WebpackPlugin_1.default.getCssMinimizerPlugin(cssMinimizer, {});
        }
        else {
