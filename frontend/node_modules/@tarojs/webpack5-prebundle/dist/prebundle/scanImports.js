...
function scanImports(_a) {
    return __awaiter(this, arguments, void 0, function* ({ appPath, chain, entries, include = [], exclude = [], customEsbuildConfig = {}, mainFields = [...helper_1.defaultMainFields] }, deps = new Map()) {
...
function getScanImportsPlugin(deps, includes, excludes) {
    ...
    return {
        ...
        setup(build) {
            ...
            // bare imports
            build.onResolve({ filter: constant_1.moduleRE }, (_a) => __awaiter(this, [_a], void 0, function* ({ path: id, importer }) {
            ...
            // catch all
            build.onResolve({ filter: /.*/ }, (_b) => __awaiter(this, [_b], void 0, function* ({ path: id, importer }) {
                const resolvedPath = yield resolve(node_path_1.default.dirname(importer), id);
...
function extractImportPaths(code) {
    ...
    code = code.replace(constant_1.multilineCommentsRE, '/* */').replace(constant_1.singlelineCommentsRE, '');
    let js = '';
    let m;
